...
import { getStudentsByParentId } from "../../dataaccess/student";
...
export default async function handleViewStudentsByParentId(
  req: Request,
  res: Response,
  ...
  try {
    ...
    const response = await getStudentsByParentId(user.centreId, id);
